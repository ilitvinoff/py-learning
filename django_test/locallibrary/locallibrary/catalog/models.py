...
class BookInstance(models.Model):
    ...
    class Meta:
        ordering = ["due_back"]
        permissions = (("librarian_perm", "May add/update/delete info"),)

    def dispaly_bookInstance(self):
        """
        Creates a string for the BookInstance. This is required to display BookInstance in Admin.
        """
        return ", ".join([BookInstance.status, BookInstance.due_back])
